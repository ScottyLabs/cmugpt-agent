...
def _campus_map_section(maps_enabled: bool) -> str:
    ...
    return (
        ...
        "A terse 'X to Y' message where X and Y are campus buildings or "
        "building codes ('ghc to cuc') is a route request: call with "
        "origin and destination. When an answer involves any "
        "campus location, lean toward attaching the map; skip it only when "
        "it clearly adds nothing.\n"
